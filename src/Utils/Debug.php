...
use _YabeKokoro\Symfony\Component\Stopwatch\Stopwatch;
use Throwable;
/**
...
class Debug
{
    ...
    public static function shutdown_stopwatch()
    {
        ...
        $log .= \PHP_EOL;
        $path = \wp_upload_dir()['basedir'] . '/kokoro/debug/stopwatch.log';
        try {
            \Yabe\Kokoro\Utils\Common::save_file($log, $path, \FILE_APPEND);
