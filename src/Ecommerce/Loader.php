...
class Loader
{
    ...
    public function scan_platforms()
    {
         ...
         */
        \do_action('a!yabe/kokoro/ecommerce/loader:scan_platforms.before_scan', $finder);
        ...
        foreach ($declared_classes as $declared_class) {
            ...
            if (!$reflector->isSubclassOf(\Yabe\Kokoro\Ecommerce\PlatformInterface::class)) {
                continue;
            }
    ...
    public function register_platforms() : void
    {
        ...
        $platforms = \apply_filters('f!yabe/kokoro/ecommerce/loader:register_platforms', $this->platforms);
