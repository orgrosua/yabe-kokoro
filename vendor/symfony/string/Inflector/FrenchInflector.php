 ...
 */
namespace _YabeKokoro\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_YabeKokoro\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_YabeKokoro\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_YabeKokoro\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_YabeKokoro\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_YabeKokoro\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_YabeKokoro\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
