 ...
 */
namespace _YabeKokoro\Composer;

use _YabeKokoro\Composer\Autoload\ClassLoader;
use _YabeKokoro\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeKokoro\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
